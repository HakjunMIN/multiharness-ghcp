...
| UAT-03 | region이 trusted domains를 제한한다 | two-region comparison | pass/fail |
| UAT-04 | telemetry opt-out이면 sink에 기록되지 않는다 | sink evidence | pass/fail |
| UAT-05 | 근거가 없으면 answer를 꾸며내지 않는다 | controlled query | pass/fail |
| UAT-06 | 429가 actionable하고 secret-safe하다 | APIM response/UI | pass/fail |
