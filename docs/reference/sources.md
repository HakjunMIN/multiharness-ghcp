> 모델 가용성은 자주 변경됩니다. 운영자는 과정 시작 전에 이 표의 내용을 반드시 다시 확인해야 합니다. 검증일: `2026-08-25`
...
| GitHub 지원 모델 목록 | https://docs.github.com/en/copilot/reference/ai-models/supported-models |
